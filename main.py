...
class DiseasePrediction:
    ...
    def make_prediction(self, saved_model_name=None, test_data=None):
        ...
        return accuracy, clf_report, precision, recall
...
if __name__ == "__main__":
    ...
    test_accuracy, classification_report, test_precision, test_recall = dp.make_prediction(saved_model_name=current_model_name)
